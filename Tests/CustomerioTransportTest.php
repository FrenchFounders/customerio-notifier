...
use FrenchFounders\CustomerioNotifier\CustomerioTransport;
 ...
 */
final class CustomerioTransportTest extends TransportTestCase
{
    public static function createTransport(HttpClientInterface $client = null, string $recipientId = null): CustomerioTransport
    {
        return new CustomerioTransport('api_key', $recipientId, $client ?? new MockHttpClient());
    }
    ...
    public function testCanSetCustomHost()
    {
        ...
        $this->assertSame(sprintf('customerio://@%s', $customHost), (string) $transport);
    }
    ...
    public function testCanSetCustomHostAndPort()
    {
        ...
        $this->assertSame(sprintf('customerio://@%s:%d', $customHost, $customPort), (string) $transport);
    }

    public static function toStringProvider(): iterable
    {
        yield ['customerio://@customer.io', self::createTransport()];
        yield ['customerio://@customer.io?recipientId=ea345989-d273-4f21-a33b-0c006efc5edb', self::createTransport(null, 'ea345989-d273-4f21-a33b-0c006efc5edb')];
    }

    public static function supportedMessagesProvider(): iterable
    {
        yield [new PushMessage('Hello', 'World'), self::createTransport(null, 'ea345989-d273-4f21-a33b-0c006efc5edb')];
        yield [new PushMessage('Hello', 'World', (new CustomerioOptions())->recipient('ea345989-d273-4f21-a33b-0c006efc5edb'))];
    }
    ...
    public function testSendThrowsWithoutRecipient()
    {
        ...
        $this->expectExceptionMessage('The "FrenchFounders\CustomerioNotifier\CustomerioTransport" transport should have configured `defaultRecipientId` via DSN or provided with message options.');
